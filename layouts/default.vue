...
<template>
    <div class="h-fit">
        <div class="flex flex-row-reverse">
            <div class=" l:w-80 lg:w-64 md:w-32 md:fixed md:h-screen text-center flex flex-col md:flex-col">
                <!-- <label @change="toggle()" for="green-toggle" class="relative items-center cursor-pointer self-end mt-2 mr-2 ">
